...
namespace fsmapper{
    ...
    public:
        ...
        virtual const std::filesystem::path &get_default_plugin_folder2() = 0;
        ...
        virtual uint32_t get_touch_cursor_delay() = 0;
        virtual void set_touch_cursor_delay(uint32_t value) = 0;
